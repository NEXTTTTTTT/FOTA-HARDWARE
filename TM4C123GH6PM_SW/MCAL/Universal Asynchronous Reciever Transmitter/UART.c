...
void UART_Init(const UART_ConfigType *configPtr)
{
    volatile uint32 * UARTRegs_Ptr = NULL_PTR;   /* point to the required UART Registers base address */
        ...
        *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_CTL_REG_OFFSET) = (*(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_CTL_REG_OFFSET) & 0xFCFE) | 0x0301;
        ...
        UARTRegs_Ptr = (volatile uint32*)UART1_BASE_ADDRESS;

        SET_BIT(SYSCTL_RCGCUART_REG, 1);
        SET_BIT(SYSCTL_RCGCGPIO_REG, 1);

        CLEAR_BIT( *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_CTL_REG_OFFSET), 0);

        switch(configPtr->UARTs[1]->BaudRate)
        {
            case 9600:
                *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_IBRD_REG_OFFSET) = 104;
                *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_FBRD_REG_OFFSET) = 11;
        ...
        *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_LCRH_REG_OFFSET) |= (configPtr->UARTs[1]->DataSize << 5);

        *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_LCRH_REG_OFFSET) |= (configPtr->UARTs[1]->ParityType << 1);
        
        *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_LCRH_REG_OFFSET) |= (configPtr->UARTs[1]->NoStopBits << 3);
        ...
        *(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_CTL_REG_OFFSET) = (*(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_CTL_REG_OFFSET) & 0xFCFE) | 0x0301;
			...
			SET_BIT(*(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_IM_REG_OFFSET), 4);
  			SET_BIT(*(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_ICR_REG_OFFSET), 4);
  			NVIC_PRI1_REG = (NVIC_PRI1_REG & 0xFF1FFFFF) | (UART1_INT_PERIORETY << 21);
  			SET_BIT(NVIC_EN0_REG, 6);
		#endif
        
    #endif   /* End #if(UART1_ENABLE==STD_ON) */
	...
	void UART0_setCallBack(void(*FuncPtr)(void) )
	{
		UART0_CallBackPtr = FuncPtr;
	...
	{
		volatile uint32 * UARTRegs_Ptr = (volatile uint32*)UART1_BASE_ADDRESS;   /* point to the required UART Registers base address */

		while(BIT_IS_SET(*(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_FLAG_REG_OFFSET), 5) );
		*(volatile uint32 *)((volatile uint8 *)UARTRegs_Ptr + UART_DATA_REG_OFFSET) = data;
	}   /* End UART0_SendByte */

	uint8 UART1_RecieveByte()
	{
		volatile uint32 * UARTRegs_Ptr = (volatile uint32*)UART1_BASE_ADDRESS;   /* point to the required UART Registers base address */
		uint8 data;
	...
	void UART1_SendString(uint8* string)
	{
		unsigned short i = 0;
	...
	void UART1_setCallBack(void(*FuncPtr)(void) )
	{
		UART1_CallBackPtr = FuncPtr;
